...
import { Send, Zap, Award, ChevronLeft, Clock, Target } from "lucide-react";
        ...
        <div className="flex flex-col gap-6">
          ...
          {currentTask && (
            <Card className="p-6 border-l-4 border-l-blue-500">
              <h3 className="font-bold text-foreground mb-2">Tarefa Atual</h3>
              <p className="text-sm text-muted-foreground mb-4">{currentTask.title}</p>
              <Button
                size="sm"
                className="w-full"
