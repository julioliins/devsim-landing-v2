import { useCombinedAuth as useAuth } from "@/hooks/useLocalAuth";
...
const menuItems = [
  { icon: LayoutDashboard, label: "Simuladores", path: "/career-selection" },
  { icon: Users, label: "Meus Simuladores", path: "/my-simulations" },
